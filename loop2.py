...
def loop2(config, writer=None):
    ...
    while epoch < config.max_epochs:
        ...
        miou_prec_rec_writing(config, y_pred_list, y_list, part='train')
        miou_prec_rec_writing_13(y_pred_list, y_list, part='train')
        ...
        if epoch % config.eval_every == 0:
            ...
            miou_prec_rec_writing(config, val_y_pred_list, val_y_list, part='val')
            miou_prec_rec_writing_13(val_y_pred_list, val_y_list, part='val')
    ...
    def miou_prec_rec_writing(config, y_pred_list, y_list, part):
    ...
    def miou_prec_rec_writing_13(y_pred_list, y_list, part):
